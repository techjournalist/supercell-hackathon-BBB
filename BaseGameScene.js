...
// TODO: Re-enable all units once sprite sheets are generated
// For now, only testing legionary walk animation
export const UNIT_SPRITE_SHEETS = {
  legionary: { walk: '/sprites/legionary_walk.png', attack: '/sprites/legionary_walk.png' },
};
